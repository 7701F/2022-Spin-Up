...
//      {
//              auton = 2;
//              if(auton = 2) lv_label_set_text(alabel, "Auton Selected: Game
// Auton");
//      }
//      else
//      {
//              auton = 1;
//              if(auton = 2) lv_label_set_text(alabel, "Auton Selected: Skills
// Auton");
//      }
...
void display() {
	...
	// lv_cont_set_fit(btn1, true, true); /*Enable resizing horizontally and
	// vertically*/ lv_obj_align(btn1, NULL, LV_ALIGN_IN_TOP_LEFT, 40, 160);
